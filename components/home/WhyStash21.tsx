  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-28 relative">
      <ScrollReveal>
        ...
        <h2 className="font-display text-3xl md:text-5xl metal-text text-center mb-16 mx-auto block w-fit">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {points.map((p, i) => (
          <ScrollReveal key={p.title} delay={i * 150}>
            <TiltCard className="hud-corners text-center px-6 card-glass rounded-2xl py-12 hover:glow-border-strong transition-shadow duration-300 h-full">
              <motion.div
